...
export function AppShell({ children, headerCenter, headerRight, activeSearchId, onSelectSearch, onNewSearch }: AppShellProps) {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-white dark:bg-[#0A0A0B]">
      {backendUnavailable && (
      ...
      <div className="flex flex-1 overflow-hidden bg-transparent">
        ...
        <main id="main-content" className={`main-panel flex-1 flex flex-col overflow-hidden min-w-0 bg-white dark:bg-[#0A0A0B] transition-[margin-left] duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] ${sidebarOpen ? "ml-[280px]" : "ml-[88px]"}`}>
