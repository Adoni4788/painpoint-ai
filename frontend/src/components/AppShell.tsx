  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-[#F0F2F5] dark:bg-[#050505]">
      ...
      <div className="flex flex-1 overflow-hidden bg-transparent">
        ...
        <main id="main-content" className="main-panel flex-1 flex flex-col overflow-hidden min-w-0 my-3 mr-3 bg-white dark:bg-[#0A0A0B] border border-gray-200/60 dark:border-white/5 shadow-sm dark:shadow-[0_0_40px_rgba(0,0,0,0.8)] border-l">
