  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-sidebar min-h-0 flex flex-col">
        ...
        {/* Search bar — icon always visible, full bar on expand/hover */}
        <div className="px-2 pt-3 pb-1">
          {/* Collapsed rail: icon-only button */}
          <div className="flex group-hover:hidden group-data-[expanded=true]:hidden justify-center">
            <button
              onClick={() => {}}
              className="w-10 h-10 flex items-center justify-center rounded-xl text-gray-400 dark:text-gray-500 hover:text-[#4d7c7a] dark:hover:text-teal-400 hover:bg-white/70 dark:hover:bg-white/8 transition-all duration-200"
          ...
          {/* Expanded: full stunning search bar */}
          <div className="hidden group-hover:block group-data-[expanded=true]:block px-1">
            <div className="relative flex items-center gap-2.5 px-3 py-2.5 rounded-2xl bg-white/70 dark:bg-white/[0.04] border border-gray-200/70 dark:border-white/[0.08] focus-within:border-[#4d7c7a]/50 dark:focus-within:border-[#4d7c7a]/40 focus-within:bg-white dark:focus-within:bg-white/[0.07] focus-within:shadow-[0_0_0_3px_rgba(77,124,122,0.08)] dark:focus-within:shadow-[0_0_0_3px_rgba(77,124,122,0.12)] transition-all duration-300 shadow-sm backdrop-blur-sm">
              <svg className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 shrink-0 transition-colors duration-200 group-focus-within:text-[#4d7c7a]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              <input
                type="text"
                ...
                className="flex-1 bg-transparent text-[12.5px] font-medium text-gray-700 dark:text-gray-300 placeholder:text-gray-400 dark:placeholder:text-gray-600 placeholder:font-normal outline-none border-none focus:ring-0 min-w-0"
              />
              {searchQuery && (
                <button
                  onClick={() => setSearchQuery("")}
                  className="shrink-0 w-4 h-4 flex items-center justify-center rounded-full bg-gray-200/80 dark:bg-white/10 text-gray-500 dark:text-gray-400 hover:bg-gray-300/80 dark:hover:bg-white/20 transition-colors"
